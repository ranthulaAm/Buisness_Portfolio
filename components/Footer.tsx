  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200 pt-16 pb-8 relative z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
               <img src="https://raw.githubusercontent.com/ranthulaAm/App/main/img/logo.png" alt="Logo" className="h-10 opacity-80 filter invert mix-blend-multiply" onError={(e) => e.currentTarget.style.display = 'none'} />
              <h3 className="text-2xl font-display font-bold text-gray-900">I'm <span className="text-purple-600">Ranthula</span></h3>
            </div>
            <p className="text-gray-500 max-w-xs font-light mb-6">
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 text-center text-sm text-gray-500 flex flex-col items-center gap-2">
