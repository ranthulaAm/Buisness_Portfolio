...
export const ConfirmationDialog: React.FC<ConfirmationDialogProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 max-w-md w-full relative z-10 animate-fade-in shadow-2xl">
                <button onClick={onCancel} className="absolute top-4 right-4 p-2 text-gray-400 hover:text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-slate-700 dark:bg-zinc-800 rounded-full transition-colors">
                    <X size={20} />
                </button>
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex gap-4 w-full">
                        <button 
                            onClick={onCancel}
                            className="flex-1 py-3 px-4 bg-gray-100 dark:bg-zinc-800 hover:bg-gray-200 text-gray-900 dark:text-white font-bold rounded-xl transition-colors"
                        >
                            {cancelText}
                        </button>
                        <button 
