...
export const OfferBanner: React.FC = () => {
    ...
    return (
        <div className="bg-gradient-to-r from-purple-800 via-pink-700 to-rose-600 animate-gradient relative overflow-hidden shadow-lg border-b border-white dark:border-zinc-700/10 z-50">
            ...
            <div className="max-w-7xl mx-auto px-4 py-2 sm:px-6 lg:px-8 relative z-10 flex ITEMS-center justify-center">
                <div className="flex items-center gap-3">
                    ...
                    <p className="font-bold text-white text-sm sm:text-base drop-shadow-sm tracking-wide">
                        <span className="opacity-90 inline-block mr-2 uppercase text-xs tracking-widest font-black bg-white/20 px-2 py-0.5 rounded backdrop-blur-md border border-white dark:border-zinc-700/30 hidden sm:inline-block">Special Offer</span>
