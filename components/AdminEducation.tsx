                    ...
                    {education.sort((a,b) => (a.order || 0) - (b.order || 0)).map((s, i) => (
                        <div key={s.id || i} className={`border border-gray-200 dark:border-zinc-700 rounded-xl p-5 flex flex-col gap-3 ${s.hidden ? 'bg-gray-100 dark:bg-zinc-800 opacity-70' : 'bg-gray-50 dark:bg-zinc-800'}`}>
                            ...
                            <textarea 
                                ...
                                className="text-sm text-gray-600 dark:text-gray-400 min-h-[60px] resize-none bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 focus:border-blue-500 rounded-lg p-3 outline-none w-full"
